...
/* install/step_4.twig */
class __TwigTemplate_50240363a9047f2738b7ceb2d5ff8e176f1fe7f823353eef00ce3d6f9bfe5232 extends Twig_Template
{
  ...
  <div class=\"support text-center\">
    <div class=\"row\">
      ...
      <div class=\"col-sm-4\"><a href=\"http://forum.opencartarab.com/index.php\" class=\"icon transition\"><i class=\"fa fa-comments fa-4x\"></i></a>
        ...
        echo "</p>
        <a href=\"http://forum.opencartarab.com/index.php\">";
        // line 65
        echo (isset($context["text_forum_visit"]) ? $context["text_forum_visit"] : null);
        echo "</a></div>
      <div class=\"col-sm-4\"><a href=\"https://www.opencart.com/index.php?route=support/partner/info&partner_id=79\" class=\"icon transition\"><i class=\"fa fa-user fa-4x\"></i></a>
        <h3>";
        // line 67
...
/*         <a href="https://www.opencartarab.com/lists/dada/mail.cgi/list/newsletter/" target="_BLANK" class="btn btn-secondary">{{ button_mail }}</a></div>*/
/*     </div>*/
/*   </div>*/
/*   <div class="core-modules">*/
/*     <div class="row">*/
...
/*         <a href="https://web.facebook.com/opencartarab/">{{ text_facebook_visit }}</a></div>*/
/*       <div class="col-sm-4"><a href="http://forum.opencartarab.com/index.php" class="icon transition"><i class="fa fa-comments fa-4x"></i></a>*/
/*         <h3>{{ text_forum }}</h3>*/
/*         <p>{{ text_forum_description }}</p>*/
/*         <a href="http://forum.opencartarab.com/index.php">{{ text_forum_visit }}</a></div>*/
/*       <div class="col-sm-4"><a href="https://www.opencart.com/index.php?route=support/partner/info&partner_id=79" class="icon transition"><i class="fa fa-user fa-4x"></i></a>*/
/*         <h3>{{ text_commercial }}</h3>*/
/*         <p>{{ text_commercial_description }}</p>*/
/*         <a href="https://www.opencart.com/index.php?route=support/partner/info&partner_id=79" target="_BLANK">{{ text_commercial_visit }}</a></div>*/
/*     </div>*/
/*   </div>*/
/* </div>*/
/* {{ footer }}*/
