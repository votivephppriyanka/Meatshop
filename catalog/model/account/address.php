...
class ModelAccountAddress extends Model {
	...
	public function editAddressapi($address_id, $data) {
	...
	public function deleteAddressapi($address_id,$customer_id) {
	...
	public function getAddressapi($address_id,$customer_id) {
	...
	public function getAddressidapi($address_id,$customer_id) {

		$address_query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "customer WHERE address_id = '" . (int)$address_id . "' AND customer_id = '" . (int)$customer_id . "'");
	...
	public function getAddressesapi($customer_id) {
		$address_data = array();
